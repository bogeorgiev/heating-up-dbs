...
compute_empirical_cap = False
compute_empirical_vol = True 
...
def plot_tau_stats():
    ...
    for dim in dims:
        xs, ys = compute_mesh(compute_empirical_vol, compute_empirical_cap, dist=0.5, dim=dim, mesh_size=7)
